...
class A2_ver2
{
	public static void main (String[]args)
	{
		...
		while(lives != 0)
		{
			...
			//Insert Game Here
			System.out.println("Press 1 for Roll, 2 for bank "); // You shouldn't be able to bank here, you should have to roll or exit completely. 
			userOption = in.nextInt();
			...
			if(nextPlayer)  // if statement is empty?
			{
				nextPlayer = false;
				turn++;
			}
