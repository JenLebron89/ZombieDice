...
class A2_ver4
{
	public static void main (String[]args)
	{
		...
		while(lives != 0)
		{
			...
			if(userOption == 1)
			{
				...
				colorresult1 = rollColor(dice1, diceColor, diceresult1, colorresult1); // will cause errow after a few turns 

				colorresult2 = rollColor(dice2, diceColor, diceresult2, colorresult2);

				colorresult3 = rollColor(dice3, diceColor, diceresult3, colorresult3);

				System.out.println(" ");
				
				// call method for dice roll
				diceresult1 = rollDice(colorresult1);
				diceresult2 = rollDice(colorresult2);
				diceresult3 = rollDice(colorresult3);
	...
	public static String rollColor (int dice, String[] diceColor, String diceresult, String colorresult) {
	...
	public static String rollDice (String diceresult){
